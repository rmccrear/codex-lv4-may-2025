---
title: Grading Rubric for TAs and Instructors
type: page
week: 9
order: 1
section: 'Week 9 '
source_file: week8/page_3994.md
---

# Grading Rubric for TAs and Instructors

[← Back to Week 9 ](README.md) / [← Course Index](../../README.md)

---

Use on Friday. Each student presents as if interviewing for a job: show the live app, walk through code, answer questions, and complete a short **live‑coding** exercise. For team projects, assess each student individually.
...
## Evaluator Flow (10–12 minutes total)
  ...
  2. **Code walkthrough** (≈3–4 min): selected files/functions, design choices, trade‑offs.
  3. **Q &A on code** (≈2–3 min): evaluator chooses areas; student explains to demonstrate understanding.
  4. **Live coding** (≈3–4 min, no AI): implement a small task from the list below.

_Tips: Look for clear communication, safe DOM practices, and ACP discipline when students reference their repo._
